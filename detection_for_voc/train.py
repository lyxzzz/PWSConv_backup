...
def main(argv=None):
    ...
    with tf.device('/gpu:%d' % gpu_id):
        ...
        train_dataset = data_loader.load_train_dataset(max_epochs + warmup_epoch - restore_epoch, preload_train_dataset, ROOT_CFG, anchors, aug_epochs=TRAIN_PARAMETERS["aug_epochs"])
