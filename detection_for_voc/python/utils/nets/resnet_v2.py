    ...
    with variable_scope.variable_scope(
        ...
        with arg_scope(
            ...
            with arg_scope([tf_layer.batch_norm], is_training=is_training):
                ...
                # Appendix of [2].
                net = tf_layer.batch_norm(
                    net, activation_fn=nn_ops.relu, scope='mypostnorm')
                if global_pool:
                ...
                if num_classes is not None:
                    end_points['Mixed_5d'] = end_points['resnet_v2_50/block2']
                    end_points['Logits'] = end_points['resnet_v2_50/mylogits']
...
def resnet_v2_50(inputs,
    ...
    # with arg_scope([slim.conv2d], padding='SAME', activation_fn=None, normalizer_fn=None):
    #         net = slim.conv2d(inputs, 64, 3, scope='conv1')
