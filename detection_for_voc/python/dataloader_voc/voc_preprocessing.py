...
def process_vocdataset(voc_type, voc_date):
    preprocessing_file_name = '/home/t/dataset/voc/VOC{}_{}.csv'.format(voc_date, voc_type)
    preprocessing_file = open(preprocessing_file_name, 'w')
    img_root_dir = '/home/t/dataset/voc/VOC{}/VOC{}/JPEGImages'.format(voc_type, voc_date)
    xml_root_dir = '/home/t/dataset/voc/VOC{}/VOC{}/Annotations'.format(voc_type, voc_date)
    if voc_type == 'train':
        trainval_file_path = '/home/t/dataset/voc/VOC{}/VOC{}/ImageSets/Main/trainval.txt'.format(voc_type, voc_date)
        trainval_img_list = []
